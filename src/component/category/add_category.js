...
const Category = () => {
  ...
  function submit(s){
    ...
    const asset = axiosPost("add_category/",
    {
      category:data.name,
    })
  ...
  return (
    <div className="App">
      ...
      <div style={{ display: "flex" }}>
        <button onClick={navigateToAssets} className="assetbackbutton fs-4" style={{width:"21%"}}>
          <b><img src={LeftArrow} alt="Arrow" height={"31%"} style={{marginRight:"5px"}}/>
          Assets/Add Category</b>
        </button>
        <Sidebutton />
      </div>
            ...
            <Row>
              <Col>
                <label style={{width:"100%"}}>
                  <p>Category Name</p>
                  <input style={{width:"100%"}} onChange={(e)=> handle(e)} id="name" value={data.name} placeholder="Category Name" name="name" />
                </label>
              </Col>
            </Row>
          </fieldset>
